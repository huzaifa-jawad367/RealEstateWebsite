...
export default function PropertiesPage() {
  ...
  return (
    <>
      <Head>
        <title>Properties for Sale in Pakistan | Real Estate Pakistan</title>
        <meta name="description" content="Browse premium properties for sale in Pakistan. Houses, apartments, villas in Islamabad, Lahore, Karachi, Rawalpindi. Expert real estate services with 15+ years experience." />
        <meta name="keywords" content="properties for sale Pakistan, houses Pakistan, apartments Pakistan, real estate listings Pakistan, property search Pakistan" />
        <link rel="canonical" href="https://realestatepakistan.com/properties" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "ItemList",
              "name": "Properties for Sale in Pakistan",
              "description": "Premium property listings in Pakistan",
              ...
              "itemListElement": properties.map((property, index) => ({
                ...
                "item": {
                  ...
                  "url": `https://realestatepakistan.com/properties/${property.id}`,
